    ...
    <footer className="bg-sky-900 text-white py-12 mt-20">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
          {/* Brand */}
          <div>
            <h3 className="text-2xl font-bold mb-2 text-orange-400">🙏 HDC</h3>
            <p className="text-gray-300 text-sm">
              Transforming your brand through creative excellence in social media and graphic design.
            </p>
          </div>
          ...
          <div>
            ...
            <div className="flex space-x-4">
              ...
              <a
                href="https://www.facebook.com/share/1DgTGHZg9B/?mibextid=wwXIfr"
                target="_blank"
                rel="noopener noreferrer"
                className="bg-orange-500 p-2 rounded-full hover:bg-orange-600 transition duration-300"
                title="Facebook"
        ...
        <div className="border-t border-sky-700 pt-8">
          <div className="flex flex-col md:flex-row justify-between items-center">
            <p className="text-gray-400 text-center md:text-left text-sm">
              &copy; {currentYear} Hanumadakshita Creators. All rights reserved. | Empowered by Devotion, Perfected in Creation!
            </p>
            <div className="flex space-x-6 mt-4 md:mt-0">
              <a href="#" className="text-gray-400 hover:text-orange-400 transition duration-300 text-sm">
                Privacy Policy
              </a>
              <a href="#" className="text-gray-400 hover:text-orange-400 transition duration-300 text-sm">
                Terms of Service
